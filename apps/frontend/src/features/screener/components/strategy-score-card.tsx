  ...
  return (
    <div className="bg-card/45 border border-border p-4 rounded-xl space-y-4 shadow-sm">
      ...
      {(() => {
          ...
          return (
            <div className="space-y-3">
              <div className="flex items-center justify-between bg-muted/10 p-2 rounded-lg border border-border/40">
                ...
                <span
                  className={`text-xs font-extrabold px-2 py-0.5 rounded border font-mono ${getScoreColor(d.total)}`}
                >
                  {d.total} / 100
                </span>
              </div>
              ...
              <div className="space-y-2.5 text-[11px]">
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(d.rvol)}`}
                      style={{ width: `${(d.rvol / 35) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(d.atr)}`}
                      style={{ width: `${(d.atr / 25) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(d.gap)}`}
                      style={{ width: `${(d.gap / 15) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(d.rsi)}`}
                      style={{ width: `${(d.rsi / 15) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(d.liquidity)}`}
                      style={{ width: `${(d.liquidity / 10) * 100}%` }}
                    ></div>
                  </div>
                </div>
              </div>
          ...
          return (
            <div className="space-y-3">
              <div className="flex items-center justify-between bg-muted/10 p-2 rounded-lg border border-border/40">
                ...
                <span
                  className={`text-xs font-extrabold px-2 py-0.5 rounded border font-mono ${getScoreColor(s.total)}`}
                >
                  {s.total} / 100
                </span>
              </div>
              ...
              <div className="space-y-2.5 text-[11px]">
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(s.trend)}`}
                      style={{ width: `${(s.trend / 35) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(s.macd)}`}
                      style={{ width: `${(s.macd / 25) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(s.rsi)}`}
                      style={{ width: `${(s.rsi / 20) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(s.volume)}`}
                      style={{ width: `${(s.volume / 10) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(s.proximity)}`}
                      style={{ width: `${(s.proximity / 10) * 100}%` }}
                    ></div>
                  </div>
                </div>
              </div>
        ...
        if (
          activeScoreTab === "position" &&
          scorePayload.positionScore
        ) {
          ...
          return (
            <div className="space-y-3">
              <div className="flex items-center justify-between bg-muted/10 p-2 rounded-lg border border-border/40">
                ...
                <span
                  className={`text-xs font-extrabold px-2 py-0.5 rounded border font-mono ${getScoreColor(p.total)}`}
                >
                  {p.total} / 100
                </span>
              </div>
              ...
              <div className="space-y-2.5 text-[11px]">
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(p.trend)}`}
                      style={{ width: `${(p.trend / 40) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(p.momentum)}`}
                      style={{ width: `${(p.momentum / 20) * 100}%` }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-muted/35 rounded-full h-1 overflow-hidden">
                    <div
                      className={`h-full ${getBarColor(p.volatility)}`}
                      style={{ width: `${(p.volatility / 15) * 100}%` }}
                    ></div>
                  </div>
                </div>
              </div>
        ...
        return (
          <div className="text-xs text-muted-foreground italic text-center py-2">
            Tidak ada data score breakdown.
          </div>
        );
      })()}
    </div>
